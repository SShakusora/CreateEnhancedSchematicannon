...
@Mixin(WirelessAccessPointBlock.class)
public abstract class WirelessAccessPointBlockMixin extends Block {
    public WirelessAccessPointBlockMixin(Properties p_49795_) {
        super(p_49795_);
    }
